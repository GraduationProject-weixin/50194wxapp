...
# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款高校学习助手小程序这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以高校学习助手小程序是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用高校学习助手小程序可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用高校学习助手小程序，其意义如下：

第一点：高校学习助手小程序的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对高校学习助手小程序设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对高校学习助手小程序进行介绍时，将按照如下内容进行。

第一部分：介绍高校学习助手小程序研究的背景意义，便于用户了解系统；

第二部分：介绍开发高校学习助手小程序需要搭建的环境，包括技术和工具；

第三部分：介绍用户对高校学习助手小程序的功能要求，以及对高校学习助手小程序的性能要求等；
...
# 第2章 开发环境与技术
高校学习助手小程序的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对高校学习助手小程序用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，高校学习助手小程序开发可行。
### 3.1.3 操作可行性
高校学习助手小程序根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作高校学习助手小程序。
...
![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教师评论.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教师评论.jpg")
图4.1 教师评论实体属性图

（2）下图是教师实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教师.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教师.jpg")
图4.2 教师实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\公告信息.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\字典表.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是课程信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\课程信息.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\课程信息.jpg")
图4.5 课程信息实体属性图

（6）下图是论坛实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\论坛.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\论坛.jpg")
图4.6 论坛实体属性图

（7）下图是学生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\学生.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\学生.jpg")
图4.7 学生实体属性图

（8）下图是课程信息评论实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\课程信息评论.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\课程信息评论.jpg")
图4.8 课程信息评论实体属性图

（9）下图是作业实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\作业.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\作业.jpg")
图4.9 作业实体属性图

（10）下图是回答实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\回答.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\回答.jpg")
图4.10 回答实体属性图

（11）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\用户表.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\用户表.jpg")
图4.11 用户表实体属性图

（12）下图是作业评论实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\作业评论.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\作业评论.jpg")
图4.12 作业评论实体属性图

（13）下图是教案信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教案信息.jpg](/md/blog.018.jpeg "C:\Users\Administrator\Desktop\img\gaoxiaoxuexizhushou\教案信息.jpg")
图4.13 教案信息实体属性图
### 4.3.1 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiaoanxinxi\_name|String|教案标题|是|
|3|jiaoanxinxi\_types|Integer|教案类型|是|
|4|jiaoanxinxi\_file|String|课件下载|是|
|5|jiaoshi\_id|Integer|教师|是|
|6|jiaoanxinxi\_content|String|教案详情|是|
...
|4|jiaoshi\_liuyan\_text|String|评论内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|kecheng\_name|String|资源标题|是|
|3|kecheng\_types|Integer|资源类型|是|
|4|kecheng\_photo|String|资源图片|是|
|5|kecheng\_video|String|资源视频|是|
|6|kecheng\_file|String|课件下载|是|
|7|banji\_types|Integer|班级|是|
|8|jiaoshi\_id|Integer|资源教师|是|
|9|kecheng\_content|String|资源详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|kecheng\_id|Integer|课程信息|是|
|3|yonghu\_id|Integer|用户|是|
|4|kecheng\_liuyan\_text|String|评论内容|是|
|5|insert\_time|Date|评论时间|是|
|6|reply\_text|String|回复内容|是|
|7|update\_time|Date|回复时间|是|
|8|create\_time|Date|创建时间|是|
...
|5|zuoye\_photo|String|封面|是|
|6|banji\_types|Integer|班级|是|
|7|zuoye\_types|Integer|作业类型|是|
|8|insert\_time|Date|作业发布时间|是|
|9|zuoye\_file|String|作业文件|是|
|10|zuoye\_content|String|作业详情|是|
|11|create\_time|Date|创建时间|是|
表4.12作业评论表
...
|2|zuoye\_id|Integer|作业|是|
|3|yonghu\_id|Integer|用户|是|
|4|zuoye\_liuyan\_text|String|评论内容|是|
|5|insert\_time|Date|评论时间|是|
|6|reply\_text|String|回复内容|是|
|7|update\_time|Date|回复时间|是|
|8|create\_time|Date|创建时间|是|
...
图5.1 教师信息管理页面
### 5.2 学生信息管理
如图5.2显示的就是学生信息管理页面，此页面提供给管理员的功能有：查看已发布的学生信息数据，修改学生信息，学生信息作废，即可删除，还进行了对学生信息名称的模糊查询 学生信息信息的类型查询等等一些条件。
...
图5.2 学生信息管理页面
### 5.3作业信息管理
如图5.3显示的就是作业信息管理页面，此页面提供给管理员的功能有：根据作业信息进行条件查询，还可以对作业信息进行新增、修改、查询操作等等。
